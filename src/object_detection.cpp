...
void colorDetectionCallback(const sensor_msgs::ImageConstPtr& original_image)
{
	...
	cv::Mat img_mask; 
	cv::inRange(cv_ptr->image,cv::Scalar(36,0,0),cv::Scalar(146,256,256),img_mask); 
...
int main(int argc, char **argv)
{
    ...
    */
    ...
    image_transport::Subscriber sub = it.subscribe("camera/image_raw", 1, objectDetectionCallback);
